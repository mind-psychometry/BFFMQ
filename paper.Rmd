...
coefficientalpha::tau.test(nonreact )
...
item26.icc <- ggicc(observe.fit.2,6,6)+ggtitle("item26")+apatheme+scale_color_npg()+
  scale_y_continuous(breaks=c(0,.5,1), limits = c(0, 1))+theme(legend.position="none")
...
personfit <- cowplot::plot_grid(observe.per.fit, des.per.fit, act.per.fit, nonj.per.fit, nonr.per.fit, labels = "auto",ncol=3, label_size = 80,align = "v",
                  label_fontface = "plain")
...
observe_tau<- coefficientalpha::tau.test (observe.refit.2 )
describe_tau <- coefficientalpha::tau.test(describe.refit.2 )
awareness_tau <- coefficientalpha::tau.test(awareness.refit.2 )
nonjudge_tau <- coefficientalpha::tau.test(nonjudge.refit.2 )
nonreact_tau <- coefficientalpha::tau.test(nonreact.refit.2 )



observe_omega <- coefficientalpha::omega(observe.refit.2 )
describe_omega <- coefficientalpha::omega(describe.refit.2 )
awareness_omega <- coefficientalpha::omega(awareness.refit.2 )
nonjudge_omega <- coefficientalpha::omega(nonjudge.refit.2 )
nonreact_omega <- coefficientalpha::omega(nonreact.refit.2 )
