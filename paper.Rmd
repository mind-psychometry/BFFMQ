...
```{r ggitem-info-all-plots}
#We used all item-info plot in the manuscript
#Observe
...
scale_y_continuous(breaks=c(0,.5,1), limits = c(0, 1))+theme(legend.position="none")+
  xlab(expression(theta)) + 
  ylab(expression(I(theta)))+geom_hline(yintercept = .20, linetype="dashed")+geom_area(aes(fill =  "#3C548899"))
...
ggsave("Figures/Fig3.png",all_info , units = "mm", width = 174, height = 234, dpi = 600, bg = "white")


```

```{r problematic-icc, include=F}
#Publication quality OCC
library(ggsci)
...
problematic_icc <- cowplot::plot_grid(
  item26.icc,item38.icc,item22.icc,item39.icc,item03.icc,item17.icc,
                               labels = "AUTO",
                               align="v",
                               ncol = 3,
                               label_size = 15,
...
ggsave("Figures/Fig4.png",problematic_icc_2 , units = "mm", width = 174, height = 117, dpi = 600, bg = "white")
...
knitr::include_graphics('Figures/Fig6.png', dpi =600)
...
ggsave("Figures/Fig5.png",personfit, units = "mm", width = 174, height = 117, dpi = 600, bg = "white")
...
knitr::include_graphics('Figures/Fig5.png', dpi =600)
...
TIC.plot <- cowplot::plot_grid(observe.TIC.1,describe.TIC.1, awareness.TIC.1,
                   ...
                   labels = "AUTO",
                     ...
                     label_fontface = "plain")
ggsave("Figures/Fig6.png",TIC.plot, units = "mm", width = 174, height = 150, dpi = 600, bg = "white")
...
ggsave("Figures/Fig7.png",reliability_plot, units = "mm", width = 174, height = 150, dpi = 600, bg = "white")
...
knitr::include_graphics('Figures/Fig7.png', dpi =600)
