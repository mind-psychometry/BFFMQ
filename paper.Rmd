...
ggsave("Figures/Fig4.tiff",problematic_icc_2 , units = "mm", width = 174, height = 117, dpi = 600, bg = "white")
...
referents <- find_referents(esem_tareget_efa, factor_names = c("f1", "f2", "f3",
                                                               "f4", "f5"))
...
esemComp::omega_esem(esem_fit,target_rot )
...
#Find the referent item for each factor
referents_higher_order <- find_referents(esem_tareget_efa_higher_order , factor_names = c("f1","f2"))
...
#Fit the model
esem_fit_higher_order <- lavaan::cfa(esem_model_higher_order, fscores, ordered = names(fscores),estimator = "WLSMV", mimic = "Mplus", std.lv=T)
