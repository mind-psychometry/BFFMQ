...
##Difficulty
very_easy_items <- IRT.details.1[which(IRT.details.1$b< -2),]
easy_items <- IRT.details.1[which(-2<IRT.details.1$b &  IRT.details.1$b<= -0.50),]
medium_items <-IRT.details.1[which(-0.51<IRT.details.1$b &  IRT.details.1$b<= 0.50),]
hard_items <-IRT.details.1[which(.51<IRT.details.1$b &  IRT.details.1$b<= 2),]
very_hard_items <-IRT.details.1[which(IRT.details.1$b> 2),]
